package se233.Asteroids_Project.model.Animation;
...
public class ExplosionEffect {
    private static final Logger logger = LogManager.getLogger(ExplosionEffect.class);
    ...
    private void loadSpriteSheet() {
        try {
            spriteSheet = new Image(getClass().getResourceAsStream("/se233/Asteroids_Project/asset/explosion.png"));
            if (spriteSheet == null) {
