...
public class PlayerProjectile extends AllObject {
    private static final Logger logger = LogManager.getLogger(PlayerProjectile.class);
    ...
    public PlayerProjectile(double x, double y, double rotation, double screenWidth, double screenHeight) {
