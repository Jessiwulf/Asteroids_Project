package se233.Asteroids_Project.model.Effect;
...
public class ProjectileEffect {
        private static final Logger logger = LogManager.getLogger(se233.Asteroids_Project.model.Effect.ProjectileEffect.class);
        ...
        public ProjectileEffect(double x, double y) {
            this.x = x;
            this.y = y;
            this.currentFrame = 0;
            this.frameCount = 4; // Adjust based on sprite sheet
        ...
        private void loadSpriteSheet() {
            try {
                spriteSheet = new Image(getClass().getResourceAsStream("/se233/Asteroids_Project/asset/ProjectileEffect.png"));
                if (spriteSheet == null) {
