...
public class NukeExplosion {
    private static final Logger logger = LogManager.getLogger(NukeExplosion.class);
    ...
    private void loadSpriteSheet() {
        try {
            spriteSheet = new Image(getClass().getResourceAsStream("/se233/Asteroids_Project/asset/BlueExplosion.png"));
            if (spriteSheet == null) {
