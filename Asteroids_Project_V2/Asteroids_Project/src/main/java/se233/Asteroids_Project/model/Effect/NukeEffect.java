...
public class NukeEffect {
    private static final Logger logger = LogManager.getLogger(NukeEffect.class);
    ...
    public NukeEffect(double x, double y) {
        this.x = x;
        this.y = y;
        this.currentFrame = 0;
        this.frameCount = 4; // Adjust based on your sprite sheet
    ...
    private void loadSpriteSheet() {
        try {
            spriteSheet = new Image(getClass().getResourceAsStream("/se233/Asteroids_Project/asset/NukeEffect.png"));
            if (spriteSheet == null) {
